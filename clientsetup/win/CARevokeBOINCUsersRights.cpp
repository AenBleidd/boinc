...
#include "stdafx.h"
#include "boinccas.h"
#include "CARevokeBOINCUsersRights.h"
#include "lsaprivs.h"


#define CUSTOMACTION_NAME               _T("CARevokeBOINCUsersRights")
...
UINT __stdcall RevokeBOINCUsersRights(MSIHANDLE hInstall)
{
    ...
    CARevokeBOINCUsersRights* pCA = new CARevokeBOINCUsersRights(hInstall);
