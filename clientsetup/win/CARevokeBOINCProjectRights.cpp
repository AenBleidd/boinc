...
#include "stdafx.h"
#include "boinccas.h"
#include "CARevokeBOINCProjectRights.h"
#include "lsaprivs.h"


#define CUSTOMACTION_NAME               _T("CARevokeBOINCProjectRights")
...
//              public property and revokes that user the
//              required rights.
//
/////////////////////////////////////////////////////////////////////
UINT __stdcall RevokeBOINCProjectRights(MSIHANDLE hInstall)
{
    UINT uiReturnValue = 0;

    CARevokeBOINCProjectRights* pCA = new CARevokeBOINCProjectRights(hInstall);
