...
#include "stdafx.h"
#include "boinccas.h"
#include "CARevokeBOINCMasterRights.h"
#include "lsaprivs.h"


#define CUSTOMACTION_NAME               _T("CARevokeBOINCMasterRights")
...
UINT __stdcall RevokeBOINCMasterRights(MSIHANDLE hInstall)
{
    ...
    CARevokeBOINCMasterRights* pCA = new CARevokeBOINCMasterRights(hInstall);
